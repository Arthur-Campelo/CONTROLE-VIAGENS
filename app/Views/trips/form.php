...
<form method="post" action="<?= $trip ? '/trips/update/' . $trip['id'] : '/trips/create' ?>">
    ...
    <input type="number" name="initial_km" value="<?= esc(old('initial_km', $trip['initial_km'] ?? '')) ?>" required><br>
    ...
    <input type="datetime-local" name="start_datetime"
           value="<?= esc(old('start_datetime', to_datetime_local($trip['start_datetime'] ?? null))) ?>" required><br>

    <label>Data/hora de chegada</label>
    <input type="datetime-local" name="end_datetime"
           value="<?= esc(old('end_datetime', to_datetime_local($trip['end_datetime'] ?? null))) ?>" required><br>
