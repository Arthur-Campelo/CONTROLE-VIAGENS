...
<div class="mx-auto max-w-md">
    <div class="card p-8 text-center">
        ...
        <h1 class="text-lg font-bold text-slate-900">Excluir motorista</h1>
        <p class="mt-2 text-sm text-slate-500">
            Confirma a exclusão de <strong class="font-semibold text-slate-700"><?= esc($driver['name']) ?></strong>?
        ...
        <div class="mt-6 space-y-2">
            ...
            <a href="/drivers" class="btn-secondary block w-full">Cancelar</a>
        </div>
    </div>
</div>
